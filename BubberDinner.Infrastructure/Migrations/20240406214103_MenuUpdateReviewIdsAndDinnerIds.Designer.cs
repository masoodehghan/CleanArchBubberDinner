...
namespace BubberDinner.Infrastructure.Migrations
{
    ...
    [Migration("20240406214103_MenuUpdateReviewIdsAndDinnerIds")]
    partial class MenuUpdateReviewIdsAndDinnerIds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BubberDinner.Domain.MenuAggregate.Menu", b =>
                {
                    b.OwnsMany("BubberDinner.Domain.DinnerAggregate.ValueObjects.DinnerId", "DinnerIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("BubberDinner.Domain.MenuReviewAggregate.ValueObjects.MenuReviewId", "MenuReviewIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
